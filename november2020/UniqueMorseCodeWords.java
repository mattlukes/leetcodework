...
class Solution {
    private static final String[] morseCodeTranslations = new String[]{".-","-...","-.-.","-..",".","..-.","--.","....","..",".---","-.-",".-..","--","-.","---",".--.","--.-",".-.","...","-","..-","...-",".--","-..-","-.--","--.."};
    ...
    public static int uniqueMorseRepresentations(String[] words) {
        ...
        for (String word : words) {
            ...
            for (int i = 0; i < word.length(); i++) {
                builder.append(morseCodeTranslations[word.charAt(i) - 'a']);
            }

            String morseWord = builder.toString();
            uniqueMorseStrings.add(morseWord);
        }
